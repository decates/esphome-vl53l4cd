...
void VL53L4CDSensor::dump_config() {
 ...
 protected:
  ...
  VL53L4CD sensor_{&Wire, A1};  // Wire object and default pin
  GPIOPin *enable_pin_{nullptr};
  uint32_t timing_budget_{33};  // Default timing budget in ms
...
std::list<VL53L4CDSensor *> VL53L4CDSensor::vl53L4CD_sensors;  // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
// bool VL53L4CDSensor::enable_pin_setup_complete = false;   // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)

VL53L4CDSensor::VL53L4CDSensor() { VL53L4CDSensor::vl53L4CD_sensors.push_back(this); }
